            ...
            if (krokDozadu == 36)
            {
                ...
                switch (volbaCernoch)
                {
                    case "ano":
                        ...
                        Console.WriteLine("Chop, Fleeca, Prison, Auta, Vagos, Casino");
                        ...
                        switch (volbaPracicky)
                        {
                            ...
                            /*case "casino":
                                ...
                                Console.WriteLine("Lamar: ");
                                Console.ResetColor();
                                Console.WriteLine("Skvělá volba. Sice to bude těžké, ale jsem si jist, že se nám to povede.");
                                Console.WriteLine("Musíme si koupit malou garáž na to, aby jsme měli kam dojet a všechno naplánovat. Abych tě ušetřil práce tak už jsemj jednu našel");
                                Console.WriteLine("Její cena je 10 000 dolarů. Určitě to bude stát za to. Máš dostatek peněz na koupi? [ANO / NE]");
                                string volbacasino1 = Console.ReadLine().ToLower();
                                bool opakovanicasino = true;
                                while (opakovanicasino == true)
                                {
                                    switch (volbacasino1)
                                    {
                                        case "ano":
                                            Console.ForegroundColor = ConsoleColor.DarkRed;
                                            Console.Write("Lester: ");
                                            Console.ResetColor();
                                            Console.WriteLine("„Skvělé, věděl jsem, že na tebe se můžu spolehnout! Sejdeme se tam a řekneme si plán. Jsi na místě a Lamar už čeká. Tady je náš plán – začneme tím, že si připravíme odvoz a vypnu kamery. Neměj starosti to zvládnu v pohodě takže se neboj.");
                                            Console.WriteLine("Ty se půjdeš podívat dovnitř a vloupeš se do kamerové místnosti. Najdeš slepá místa kamer. Potom zkušíš najít způsoby, jak se dostat dovnitř.“ [ANO / NE]");
                                            string volbaCasino2 = Console.ReadLine().ToLower();
                                            opakovanicasino = false;
                                            if (volbaCasino2 == "Ano")
                                            {
                                                Console.ForegroundColor = ConsoleColor.DarkRed;
                                                Console.Write("Lester: ");
                                                Console.ResetColor();
                                                Console.WriteLine("„Fajn, počítal jsem s tebou! Počítej s tím, že to nebude procházka růžovým sadem.“");
                                                Console.WriteLine("Byl jsi v kasíně a zjistil jsi 3 způsoby, jak se dostat dovnitř.“ [1 - Pomalu se plížit / 2 - použití zbraní a udělat to rychle / 3 - převléct se za zaměstnance]");
                                                int volbaCasino3 = Convert.ToInt32(Console.ReadLine());
                                                switch (volbaCasino3)
                                                {
                                                    case 1:
                                                        Console.ForegroundColor = ConsoleColor.DarkRed;
                                                        Console.Write("Lester: ");
                                                        Console.ResetColor();
                                                        Console.WriteLine("„Dobře, uděláme to pomalu, ale jistě! Ticho a klidně, jinak si nás všimnou.");
                                                        Console.WriteLine("Jsi na místě. Jdeš zadním vchodem a vidíš kameru. Kamera poř");
                                                        Console.WriteLine("Jsi na místě. Jdeš zadním vchodem a vidíš kameru. Kamera pořád funguje a přibližuje se bodyguard");
                                                        Console.WriteLine("1 - Zneškodnit ho / 2 - Počkat na vypnutí kamery");
                                                        int volbaCasino4 = Convert.ToInt32(Console.ReadLine());
                                                        switch (volbaCasino4)
                                                        {
                                                            case 1:
                                                                Console.WriteLine("Byl jsi viděn na kameře, našli tě a zabili.");
                                                                Console.ForegroundColor = ConsoleColor.DarkRed;
                                                                Console.WriteLine("wasted");
                                                                Console.Clear();
                                                                Environment.Exit(0);
                                                            ...
                                                            case 2:
                                                                Console.ForegroundColor = ConsoleColor.DarkRed;
                                                                Console.Write("Vysílačka: ");
                                                                Console.ResetColor();
                                                                Console.WriteLine("Kamery jsou vypnuté, máš 32 minut odteď. Hodně štěstí");
                                                                Console.WriteLine("„OK, kámo. Schováváš se za pracovní deskou a vidiíš 5 bodyguardů. Co udělaš?");
                                                                Console.WriteLine("Radši chceš počkat na správnou chvíli a proklouznout mezi něma nebo je vystřílet?");
                                                                Console.WriteLine("1 - počkat na správnou chvíli / 2 - vystřílet");
                                                                int volbaCasino5 = Convert.ToInt32(Console.ReadLine());
                                                                switch (volbaCasino5)
                                                                {
                                                                    case 1:
                                                                        Console.ForegroundColor = ConsoleColor.DarkRed;
                                                                        Console.Write("vysílačka: ");
                                                                        Console.ResetColor();
                                                                        Console.WriteLine("„Chytrý tah! Vidím tě na kameře. Odboč doprava a jsi skoro tam“");
                                                                        Console.WriteLine("Dej si ale pozor, ať nás nenachytají!“");
                                                                        Thread.Sleep(1000);
                                                                        Console.ForegroundColor = ConsoleColor.DarkBlue;
                                                                        Console.WriteLine(" [1 - Ano / 2 - Ne]"); //dodělat potom
                                                                        Console.ResetColor();
                                                                        int volbaChop13 = Convert.ToInt32(Console.ReadLine());
                                                                        break;*/
                                    }
